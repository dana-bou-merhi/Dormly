...
import { MapPin, Home, Search,Users, TrendingUp } from "lucide-react";
...
export default function HeroSection() {
  ...
  const handlePopular = (label) => setLocation(label);
  ...
  <section className="relative pt-10 pb-25 lg:pb-40 bg-linear-to-b from-gray-50 to-white overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
         <img src="/images/Homepage2.png" alt="Students studying" className="w-full h-full object-cover"></img>
        <div className="absolute inset-0 bg-linear-to-b from-teal-900/10 to-teal-900/30 mix-blend-multiply"></div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 text-center">
        ...
        <form onSubmit={handleSearch}  className="mt-12 max-w-4xl mx-auto bg-white rounded-2xl shadow-lg p-4 md:p-6 grid 
        grid-cols-1 md:grid-cols-12 gap-4 items-end" >
          ...
          <div className="md:col-span-5 text-left">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="block w-full pl-10 pr-3 py-3 border border-gray-200 rounded-lg leading-5 bg-gray-50 placeholder-gray-400 focus:outline-none focus:bg-white focus:ring-2 focus:ring-teal-500 transition"
              />
            </div>
          </div>
          ...
          <div className="md:col-span-5 text-left">
            ...
            <div className="relative">
              ...
              <select  value={type}   onChange={(e) => setType(e.target.value)}
                className="block w-full pl-10 pr-10 py-3 border border-gray-200 rounded-lg leading-5 bg-gray-50 text-gray-700
                 focus:outline-none focus:bg-white focus:ring-2 focus:ring-teal-500 transition appearance-none" >
          ...
          <div className="md:col-span-2">
           ...
           {/* ── Popular searches row (spans full form width) ─────────── */}
            <div className="md:col-span-12 pt-3 border-t border-gray-100">
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    {POPULAR_SEARCHES.map((s) => (
                      <button key={s.label} type="button"   onClick={() => handlePopular(s.label)}  className="inline-flex items-center gap-1.5 text-xs font-medium text-gray-600
                                   bg-gray-50 hover:bg-teal-50 hover:text-teal-700 border border-gray-200
                                   hover:border-teal-200 px-3 py-1.5 rounded-full transition-all duration-150" >
                        <span>{s.icon}</span>
                        {s.label}
                      </button>
                    ))}
